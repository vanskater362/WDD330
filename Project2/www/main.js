...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => Promise.all(/*! import() | mileage-tracker-mileage-tracker-module */[__webpack_require__.e("common"), __webpack_require__.e("mileage-tracker-mileage-tracker-module")]).then(__webpack_require__.bind(null, /*! ./mileage-tracker/mileage-tracker.module */ "./src/app/mileage-tracker/mileage-tracker.module.ts")).then(m => m.MileageTrackerPageModule)
            },
            {
                path: 'miles-tracker-list',
                loadChildren: () => Promise.all(/*! import() | mileage-tracker-miles-tracker-list-miles-tracker-list-module */[__webpack_require__.e("common"), __webpack_require__.e("mileage-tracker-miles-tracker-list-miles-tracker-list-module")]).then(__webpack_require__.bind(null, /*! ./mileage-tracker/miles-tracker-list/miles-tracker-list.module */ "./src/app/mileage-tracker/miles-tracker-list/miles-tracker-list.module.ts")).then(m => m.MilesTrackerListPageModule)
            }
        ]
    },
    {
        ...
        children: [
            ...
            {
                path: 'register',
                loadChildren: () => __webpack_require__.e(/*! import() | login-register-register-module */ "common").then(__webpack_require__.bind(null, /*! ./login/register/register.module */ "./src/app/login/register/register.module.ts")).then(m => m.RegisterPageModule)
            }
        ]
    },
    {
...
module.exports = __webpack_require__(/*! D:\One Drive\OneDrive - BYU-Idaho\School\WDD 330\WDD330\Project2\src\main.ts */"./src/main.ts");
